...
This document defines the approved technology stack for graphrag-mcp-server. All development MUST use these technologies unless explicitly approved via Phase -1 Gate (Article VIII: Anti-Abstraction).
